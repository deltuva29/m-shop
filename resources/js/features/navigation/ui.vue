...
<template>
  <div class="relative flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
    <div id="cart-menu" v-click-outside="closeDropdownMenu" class="items-center justify-between font-medium w-full md:flex md:w-auto md:order-1">
      <nav class="header-navigation">
        <ul class="flex flex-row p-4 md:p-0 mt-4 border-0 border-gray-100 rounded-lg bg-transparent md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          ...
          <button @click="toggleDropdownMenu" class="flex items-center text-sm rounded-full md:me-0 focus:ring-0 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
